...
def is_main_evaluation_factor(entity: Dict) -> bool:
    """
    Identify main evaluation factors vs supporting entities.
    
    Government RFPs have 3-8 main factors BUT 40-100+ total eval factor entities.
    ...
    main_factor_patterns = [
        ...
        'subfactor', 'technical factor', 'price factor', 'cost factor', 'management factor',
        'tomp', 'past performance', 'small business', 'mission essential', 'quality control plan'
    ]
    ...
    excludes = [
        ...
        'analysis', 'assessment', 'government evaluation',
        '%', 'cei', 'sei', 'kpi', 'index',
        '(table)', 'table', 'outline'
    ]
    if any(term in name_lower for term in excludes):
        return False
