...
async def main():
    ...
    logger.info(f"   {CYAN}├─>{RESET} LLM: {os.getenv('LLM_MODEL', 'grok-4-fast-reasoning')}")
    ...
    logger.info(f"  {CYAN}Reasoning:{RESET}        {os.getenv('REASONING_LLM_NAME', 'grok-4-fast-reasoning')} {GREEN}(reasoning){RESET}")
