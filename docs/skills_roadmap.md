...
| **4**   | External datasources (SAM.gov, USAspending, eCFR, GSA CALC+, GSA Per Diem, Federal Register, BLS OEWS) | 🟡 4a–4e+4f.1+4f.2+4f.3+4f.4+4f.5+4f.6+4f.7 done | `ecbcc29` (client), `1d3df18` (USAspending), `2cf328d` (competitive-intel promoted), `226d214` (eCFR vendored), `f9ad45f` (gsa-calc vendored), `d058d2a` (gsa-perdiem vendored), `73a2a94` (federal-register vendored), `0a0fbca` (4e MCP Servers panel), `cf003e9` (4f.2 compliance-auditor consumes eCFR), `0098fb0` (4f.6 sam-gov vendored), `6793c10` (4f.7 bls-oews vendored). 4f.8–4j pending. |
