...
| **4**   | External datasources (SAM.gov, USAspending, eCFR, GSA CALC+, GSA Per Diem, Federal Register, BLS OEWS, Regulations.gov) | 🟡 4a–4e+4f.1–4f.8+4g+4h done | `ecbcc29` (client), `1d3df18` (USAspending), `2cf328d` (competitive-intel promoted), `226d214` (eCFR vendored), `f9ad45f` (gsa-calc vendored), `d058d2a` (gsa-perdiem vendored), `73a2a94` (federal-register vendored), `0a0fbca` (4e MCP Servers panel), `cf003e9` (4f.2 compliance-auditor consumes eCFR), `0098fb0` (4f.6 sam-gov vendored), `6793c10` (4f.7 bls-oews vendored), `79a0846` (4f.8 regulations-gov vendored — closes MCP-vendoring stretch), `49f20f7` (4g price-to-win skill: 3 IGCE Builder upstreams collapsed into one bidder-stance skill consuming bls_oews + gsa_calc + gsa_perdiem), `76682c6` (4h sow-pws-builder split into subcontractor-sow-builder forward + rfp-reverse-engineer reverse, each owning its own references). 4i–4j pending. |
