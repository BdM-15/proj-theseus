...
(prompts/extraction/govcon_lightrag_native.txt). This ensures VLM output primes
...
Cross-reference:
  ...
  - Extraction prompt: prompts/extraction/govcon_lightrag_native.txt (Part D entity catalog)
