...
1. Explore the repo to understand the current state of the codebase, if you
   ...
   the PRD, and respect any ADRs in the area you're touching.
...
3. Write the PRD using the template below, then publish it to the project
   issue tracker. Apply the `needs-triage` triage label so it enters the
   normal triage flow.
