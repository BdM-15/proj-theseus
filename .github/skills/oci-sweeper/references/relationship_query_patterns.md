...
Cypher / KG query templates the skill uses against the active Theseus workspace to surface candidate OCI parties and the relationships among them. The KG schema follows `src/ontology/schema.py` (32 entity types, 26 relationship types).
