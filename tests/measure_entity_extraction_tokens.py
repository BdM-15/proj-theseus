...
orig = root / "prompts" / "extraction" / "entity_extraction_prompt.md"
opt = root / "prompts" / "extraction_optimized" / "entity_extraction_prompt.txt"
...
print("Entity Extraction Prompt Token Measurement")
print("=========================================")
